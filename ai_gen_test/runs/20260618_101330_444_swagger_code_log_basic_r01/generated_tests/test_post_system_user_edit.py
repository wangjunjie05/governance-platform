...
def test_post_system_user_edit_case_1():
    url = f"{BASE_URL}/system/user/edit"
    ...
    payload = {'userId': '116', 'deptId': '106', 'userName': '创维11', 'dept.deptName': '财务部门', 'phonenumber': '13334455443', 'email': '', 'loginName': '创维11', 'sex': '0', 'remark': '', 'status': '0', 'roleIds': '', 'postIds': ''}
